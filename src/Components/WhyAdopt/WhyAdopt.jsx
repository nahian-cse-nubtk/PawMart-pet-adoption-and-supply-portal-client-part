...
export default function WhyAdopt() {
  ...
  return (
    <section className="py-20 bg-linear-to-b from-orange-50 to-white text-center">
      <motion.h2
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {reasons.map((item, index) => (
          <motion.div
            key={index}
            className="p-8 bg-white shadow-lg rounded-2xl hover:shadow-xl transition-all border border-orange-100"
